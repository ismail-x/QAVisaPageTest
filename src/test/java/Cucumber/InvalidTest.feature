...
#      | Somalia    | Japan        | ismail    | ismail   | Invalidemail | idjdid      | 90       | multiple | study_visa | THIS IS A NOTE | We have received your visa details, and one of our representatives will contact you shortly. Your visa registration number is |
#
...
Feature: Visa Order
  ...
  @InvalidTest
  Scenario Outline: Negative test of submitting the visa order
    Given Inserting from country <negaraAsal> and to country <negaraTujuan> and current date
    Given Enter first name <firstName> and last name <lastName> and Enter email <email> and phone number <phoneNumber> and with duration <visaDays> and entry type <entry> and Select visa type <visa> and Add notes <notes>
    Then I should see the confirmation message <expectedText>
    ...
    Examples:
      | negaraAsal | negaraTujuan | firstName | lastName | email    | phoneNumber | visaDays | entry    | visa       | notes          | expectedText                                                                                                                  |
      | Somalia    | Japan        | ismail    | ismail   | asdd.com | asdd112     | 90       | multiple | study_visa | THIS IS A NOTE | We have received your visa details, and one of our representatives will contact you shortly. Your visa registration number is |
