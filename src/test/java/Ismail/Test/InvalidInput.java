...
public class InvalidInput extends BaseTest {

    @Test(dataProvider = "getData", retryAnalyzer = Retry.class)
    public void CompleteNegativeTest(HashMap<String, String> input) throws InterruptedException {
...
//        landingPage.submitCountry("negaraAsal","NegaraTujuan");
    ...
    public Object[][] getData() throws IOException {
        List<HashMap<String, String>> data = getJsonDataToMap(System.getProperty("user.dir")+"//src//test//java//Ismail//Data//InvalidInput.json");
